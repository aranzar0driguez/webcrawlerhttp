const {normalizeURL, getURLsFromHTML, normalizeRootURL, convertIntoMarkDown} = require('./crawl.js')
...
test('normalizeRootURL check for http', () => {
    const input = 'wagslane.dev'
    const actual = normalizeRootURL(input)
    const expected = 'http://wagslane.dev'
    expect(actual).toEqual(expected)
})
